...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_44.rg, _node_2)).rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_45.rg, _node_2)).rgb;
/// Final Color:
