...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_node_23,TRANSFORM_TEX(node_27.rg, _node_23))).rgb;
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_node_23,TRANSFORM_TEX(node_28.rg, _node_23))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
