...
/*SF_DATA;ver:0.36;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32465,y:32580|diff-2-RGB,spec-9-RGB,normal-3-RGB;n:type:ShaderForge.SFN_Tex2d,id:2,x:32954,y:32562,ptlb:node_2,ptin:_node_2,tex:73870973ef43021478983dd74214a475,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3,x:32967,y:32744,ptlb:node_3,ptin:_node_3,tex:ad8b104e4ccdab143b8c72504def560e,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:9,x:32768,y:32965,ptlb:node_9,ptin:_node_9,tex:eb404605abaa315418fd7c29f95b5a1e,ntxv:0,isnm:False;proporder:3-2-9;pass:END;sub:END;*/
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float3 specularColor = tex2D(_node_9,TRANSFORM_TEX(node_13.rg, _node_9)).rgb;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float3 specularColor = tex2D(_node_9,TRANSFORM_TEX(node_14.rg, _node_9)).rgb;
