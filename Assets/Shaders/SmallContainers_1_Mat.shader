...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_normal,TRANSFORM_TEX(node_23.rg, _normal))).rgb;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 node_2 = tex2D(_diffuse,TRANSFORM_TEX(node_24.rg, _diffuse));
                float3 specularColor = node_2.rgb;
