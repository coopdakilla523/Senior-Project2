...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_node_3,TRANSFORM_TEX(node_13.rg, _node_3)).rgb;
...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_node_3,TRANSFORM_TEX(node_14.rg, _node_3)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
